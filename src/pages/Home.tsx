...
// 1. Import APIProduct type alongside the component
...
// REMOVED: The local Product interface that caused the conflict
// We now use APIProduct from the component file

// Default banners if backend has none
...
const features = [
  {
    ...
    description:
      "Handpicked sarees from trusted artisans ensuring premium quality and authenticity.",
    gradient: "from-primary/20 to-primary/5",
  },
  {
    title: "Timeless Elegance",
    description:
      "Classic designs that blend traditional craftsmanship with modern aesthetics.",
    gradient: "from-accent/20 to-accent/5",
  },
  {
    title: "Customer Satisfaction",
    description:
      "Dedicated support and hassle-free shopping experience for all our valued customers.",
...
const Home = () => {
  ...
  useEffect(() => {
    axios
      ...
      .catch((err) =>
        console.error("Failed to load banners, using default:", err)
      );
  }, []);
  ...
  useEffect(() => {
    axios
      .get(`${BASE_URL}/products/latest/?limit=8`)
            ...
            <div className="relative container mx-auto px-4 h-full flex items-center">
              ...
              >
                ...
                <Link to="/collections">
                  <Button
                    size="lg"
                    className="bg-accent hover:bg-accent-dark text-accent-foreground text-sm sm:text-base md:text-lg px-4 sm:px-6 md:px-8 py-3 sm:py-4 md:py-6 transition-smooth shadow-glow group"
                  >
      ...
      <section className="container mx-auto px-4 py-8 sm:py-12 md:py-16">
        <div className="text-center mb-8 md:mb-12">
          ...
          <p className="text-sm sm:text-base md:text-lg text-muted-foreground max-w-2xl mx-auto">
            Handpicked selections of our finest sarees, crafted with love and
            tradition
          </p>
        </div>
